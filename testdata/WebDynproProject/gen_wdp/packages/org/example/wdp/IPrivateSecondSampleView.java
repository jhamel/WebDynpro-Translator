...
public interface IPrivateSecondSampleView {
  ...
  {
    private InternalSecondSampleView gen_delegate;

    IContextNode(InternalSecondSampleView delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateSecondSampleView.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateSecondSampleView.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateSecondSampleView.IContextElement createContextElement() {
      return (IPrivateSecondSampleView.IContextElement)createElement();
    }
     ...
     */
    public void bind(IPrivateSecondSampleView.IContextElement element) {
     ...
     */
    public IPrivateSecondSampleView.IContextElement currentContextElement() {
      return (IPrivateSecondSampleView.IContextElement) getCurrentElement();
    }
  ...
  public static class IContextElement extends com.sap.tc.webdynpro.progmodel.context.NodeElement
  {
    ...
    public IContextElement(InternalSecondSampleView delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
