...
public interface IPublicSampleComponentInterfaceCfg extends org.example.wdp.IExternalSampleComponentInterfaceCfg {
  ...
  {
    private InternalSampleComponentInterfaceCfg gen_delegate;

    IContextNode(InternalSampleComponentInterfaceCfg delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateSampleComponentInterfaceCfg.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateSampleComponentInterfaceCfg.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateSampleComponentInterfaceCfg.IContextElement createContextElement() {
      return (IPrivateSampleComponentInterfaceCfg.IContextElement)createElement();
    }
     ...
     */
    public void bind(IPrivateSampleComponentInterfaceCfg.IContextElement element) {
     ...
     */
    public IPrivateSampleComponentInterfaceCfg.IContextElement currentContextElement() {
      return (IPrivateSampleComponentInterfaceCfg.IContextElement) getCurrentElement();
    }
  ...
  public static class IContextElement extends com.sap.tc.webdynpro.progmodel.context.NodeElement
  {
    ...
    public IContextElement(InternalSampleComponentInterfaceCfg delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
